...
class ProviderService:
    ...
    def create(self, data: ProviderInputSchema) -> ProviderOutputSchema:
    ...
    def get_details(self, _id: int) -> ProviderOutputSchema:
    ...
    def update_api_key(self, _id: int, data: ProviderUpdateApiKeySchema) -> ProviderOutputSchema:
        if not self.provider_repository.provider_exists_by_id(_id):
            raise HTTPException(status_code=404, detail="Provider not found")
    ...
    def get_all(self) -> List[ProviderOutputSchema]:
